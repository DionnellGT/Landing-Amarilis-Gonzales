  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-margin-mobile md:px-gutter max-w-4xl mx-auto fade-and-slide-up visible">
        ...
        <a
          className="rounded-xl inline-flex items-center justify-center px-8 py-4 bg-[#be6a3d] text-primary font-label-md hover:bg-surface transition-colors duration-300"
          href={data.ctaHref}
        >
          {data.ctaLabel}
        </a>
